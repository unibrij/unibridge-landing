// unibridge-landing/surface/coinsph-picker.js

/*
--------------------------------------------------
CoinsPH picker orchestrator
--------------------------------------------------
*/

import {
  buildCoinsPhBankGroups,
  fetchCoinsPhChannelOptions,
  getOptionChannel,
  getOptionLabel,
  getOptionSubject,
  normalizeSearchText
} from "./coinsph/coinsph-options.js";

import {
  buildCoinsPhDestination,
  validateCoinsPhDestinationInput
} from "./coinsph/coinsph-destination.js";
...
} from "./coinsph/coinsph-render.js";
...
export function createCoinsPhPicker({
  ...
  async function load() {
    ...
    try {
      const options =
        await fetchCoinsPhChannelOptions({
          apiGet
        });

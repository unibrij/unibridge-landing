  ...
  function attachEvents(
    ...
    instance.on(
      ...
      (event) => {
        ...
        if (
          ...
          /*
          Return the user to UniBridge immediately after
          Onramp reports the on-chain transaction hash.

          Keep this instance marked as completed so the
          close event generated by close() cannot replace
    ...
    instance.on(
      ...
      (event) => {
        ...
        /*
        close() after a completed transaction may emit
        CLOSE_REQUEST_CONFIRMED. Consume that event
        without changing UniBridge's successful status.
        */
        if (
          type ===

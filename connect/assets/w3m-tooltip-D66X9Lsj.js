import{at as e,b as t,it as n,k as r,st as i,t as a}from"./ModalController-BpI2CVep.js";import{C as o,b as s,c,g as l,l as u,s as d,v as f}from"./wui-text-BYsKclfS.js";import"./wui-icon-BwVM7EqR.js";var p=e({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=r({state:p,subscribe(e){return i(p,()=>e(p))},subscribeKey(e,t){return n(p,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=o`
  :host {
    width: 100%;
    display: block;
  }
